...
l'enfoncement (déplacement imposé) d'une sonde rigide (MyotonPRO, une seule impulsion).
...
(cf. dossier Fits_Ogden_Prony, tableau dans le mémoire). Sur LS-DYNA, la normalisation 
...
3. Conditions aux limites et Chargements
  ...
  l'empilement à gras faible (cf section "Validation de la mesure"). Durée d'impulsion ~7 ms, suivie d'une 
...
4. Contacts et Paramètres de calcul
  ...
  et des historiques globaux (GLSTAT, RCFORC, NODEFOR, ELOUT toutes les 0,1 ms).
